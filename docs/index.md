...
Assignment details can be found on each unit's assignments page. Assignment will be turned in on your website or in Box. Grades will be accessible through Canvas.
...
* Comments (1 point each). You can earn up to 2 points per unit by engaging with another student's blog post. Comments must be 100+ words and be relevant to the post. Ask questions! 
